...
public class RestApiController {
	...
	public ResponseEntity<List<User>> listAllUsers() {
		List<User> users = userService.findByStatus(STATUS.ACTIVE.toString());
		if (users.isEmpty()) {
	...
	public ResponseEntity<?> createUser(@RequestBody User user) {
		...
		if (userService.isValid(user)) {
			...
			return new ResponseEntity(new CustomErrorType("Unable to create. A User without name " + 
			user.getFirstName() +"Last Name"+user.getLastName() ),HttpStatus.BAD_REQUEST);
		}
	...
	public ResponseEntity<?> deleteUser(@PathVariable("id") long id) {
		...
		currentUser.setStatus(STATUS.INACTIVE.toString());
		userService.updateUser(currentUser);
